...
DATAPOINTS = {
    ...
    67: ("Mischerkreis1", "Stoerung", "DPT_Switch", False),
    ...
    80: ("Mischerkreis2", "Stoerung", "DPT_Switch", False),
    ...
    149: ("CWL_Wohnraumlueftung", "Programm", "DPT_HVACMode", True),
    ...
    158: ("CWL_Wohnraumlueftung", "Zeitw. Feuchteschutz AN_AUS", "DPT_Switch", True),
    159: ("CWL_Wohnraumlueftung", "Zeitw. Feuchteschutz Startdatum", "DPT_Date", True),
    160: ("CWL_Wohnraumlueftung", "Zeitw. Feuchteschutz Enddatum", "DPT_Date", True),
    161: (
        "CWL_Wohnraumlueftung",
        "Zeitw. Feuchteschutz Startzeit",
        "DPT_TimeOfDay",
        True,
    ),
    162: (
        "CWL_Wohnraumlueftung",
        "Zeitw. Feuchteschutz Endzeit",
        "DPT_TimeOfDay",
        True,
    ),
    ...
    355: (
        "Bedienmodul_BM2",
        "Erkennung verfuegbarer Geraete 1",
        "DPT_Value_2_Ucount",
        False,
    ),
    356: (
        "Bedienmodul_BM2",
        "Erkennung verfuegbarer Geraete 2",
        "DPT_Value_2_Ucount",
        False,
    ),
    357: (
    ...
    358: ("Bedienmodul_BM2", "Erkennung Warmwasserkreise", "DPT_Value_1_Ucount", False),
    359: (
        "Bedienmodul_BM2",
        "Unterscheidung Heizgeraetetyp (Heizgeraet2)",
        "DPT_Value_1_Ucount",
        False,
    ),
    360: (
        "Bedienmodul_BM2",
        "Unterscheidung Heizgeraetetyp (Heizgeraet3)",
        "DPT_Value_1_Ucount",
        False,
    ),
    361: (
        "Bedienmodul_BM2",
        "Unterscheidung Heizgeraetetyp (Heizgeraet4)",
        "DPT_Value_1_Ucount",
        False,
    ),
    ...
    368: (
        "Direkter_Heizkreis_WW",
        "Vorlaufsolltemperatur dir. HK",
        "DPT_Value_Temp",
        False,
    ),
...
DP_VALUES_ALLOWED = {
    ...
    57: (HVACModes[0], HVACModes[1], HVACModes[2], HVACModes[3]),
    ...
    70: (HVACModes[0], HVACModes[1], HVACModes[2], HVACModes[3]),
    ...
    83: (HVACModes[0], HVACModes[1], HVACModes[2], HVACModes[3]),
    ...
    96: (HVACModes[0], HVACModes[1], HVACModes[2], HVACModes[3]),
    ...
    149: (HVACModes_CWL[0], HVACModes_CWL[1], HVACModes_CWL[3]),
    150: (0, 1),
    151: (0, 1),
    152: (0, 1),
    153: (0, 1),
